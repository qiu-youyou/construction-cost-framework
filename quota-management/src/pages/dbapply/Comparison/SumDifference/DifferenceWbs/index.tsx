 ...
 * @LastEditTime: 2024-03-21 18:36:53
...
import { sumWbsQueryDifference } from '../services';
...
export default (props: Props) => {
  ...
  const fetchDataSourceRequest: any = async (p: FETCH.Req<DifferenceQuery>) => {
    const res = await sumWbsQueryDifference(p);
  ...
  const generateTable: BaseTableProps<DifferenceData, DifferenceQuery> = {
    ...
    persistenceKey: 'PAGES_DBAPPLY_COMPARISON_SUMDIFFERENCE_WBSTABLE',
