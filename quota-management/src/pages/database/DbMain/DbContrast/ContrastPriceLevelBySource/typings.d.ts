/*
 * @Author: SHUANG
 * @Date: 2023-11-13 13:43:11
 * @LastEditors: s_qiu s.qiu@foxmail.com
 * @LastEditTime: 2023-11-17 11:52:21
 * @Description: 企业定额修编-定额造价水平对比-与来源库对比
 */

/** 定额造价水平对比-与来源库对比 查询参数 */
export type DbPriceLevelBySourceQuery = {
  currentDbId: string; // 当前库Id
  sourceDbId: string; // 来源库Id
};

/** 定额造价水平对比-与来源库对比 - 定额 数据项 */
export type DbPriceLevelBySourceNormItem = {
...
/** 定额造价水平对比-与来源库对比 - MAT 数据项 */
export type DbPriceLevelBySourceMatItem = {
  currentMatCode: string; // 材料编号 当前库
  currentMatName: string; // 材料名称当前库
  currentMatUnit: string; // 材料单位当前库
  currentMatPrice: string; // 材料单价当前库
  sourceMatCode: string; // 材料编号 来源库
  sourceMatName: string; // 材料名称来源库
  sourceMatUnit: string; // 材料单位来源库
  sourceMatPrice: string; // 材料单价来源库
  matPriceDifference: string; // 材料单价 后 -前 差值
  matPricePercentage: string; // 材料单价 （后 -前）/前 百分比
};
